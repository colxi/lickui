...
export default class {
  private static async binanceFetch(requestUrl: string, method = 'GET', passUrlParams = true): Promise<any> {
  ...
  static async getExchangeInfo(): Promise<any> {
    const data: any = await this.binanceFetch('https://api.binance.com/api/v3/exchangeInfo', 'GET', false)
    return data
  }
  ...
  static async getFuturesAccount(): Promise<any> {
    const data: any = await this.binanceFetch('https://fapi.binance.com/fapi/v2/account', 'GET')
    return data
  }
  ...
  static async getOpenFutureOrders(): Promise<BinanceFuturesAPIOrder[]> {
    return await this.binanceFetch('https://fapi.binance.com/fapi/v1/openOrders')
  }
  ...
  static async getLastWeekFutureOrders(symbol: AssetPair): Promise<BinanceFuturesAPIOrder[]> {
    ...
    return await this.binanceFetch(`https://fapi.binance.com/fapi/v1/allOrders?limit=1000&symbol=${symbol}`, 'GET')
  }

  static async getFuturesUserDataKey(): Promise<string> {
    const data: any = await this.binanceFetch('https://fapi.binance.com/fapi/v1/listenKey', 'POST', false)
    return data['listenKey']
  }

  static async getUserCommissionRates(): Promise<any> {
    const data: any = await this.binanceFetch('https://fapi.binance.com/fapi/v1/commissionRate', 'GET')
    return data
  }
  ...
  static async getUserDataKey(): Promise<string> {
    ...
    const data: any = await this.binanceFetch('https://api.binance.com/api/v3/userDataStream', 'POST', false)
    return data['listenKey']
  }

  static async getFuturesBalance(): Promise<BinanceBalanceData> {
    const data = await this.binanceFetch('https://fapi.binance.com/fapi/v2/balance')
